...
public class BuildVars {
    ...
    public static int BUILD_VERSION = 2595;
    public static String BUILD_VERSION_STRING = "1.7.1";
    public static int TELEGRAM_BUILD_VERSION = 2594;
    public static String TELEGRAM_VERSION_STRING = "8.6.1";
