...
public class BuildVars {
    ...
    public static int BUILD_VERSION = 2640;
    public static String BUILD_VERSION_STRING = "1.8.3 Beta 4";
    public static int TELEGRAM_BUILD_VERSION = 2635;
    public static String TELEGRAM_VERSION_STRING = "8.7.3";
