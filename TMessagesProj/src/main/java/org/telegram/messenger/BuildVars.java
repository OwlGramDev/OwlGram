...
public class BuildVars {
    ...
    public static int BUILD_VERSION = 2589;
    public static String BUILD_VERSION_STRING = "1.7.0";
    public static int TELEGRAM_BUILD_VERSION = 2587;
    public static String TELEGRAM_VERSION_STRING = "8.6.0";
