                ...
                if (position == changePasscodeRow) {
                    ...
                    numberPicker.setFormatter(value -> {
                        if (value == 0) {
                            ...
                            return LocaleController.formatString("OwlgramAutoLockInstant", R.string.OwlgramAutoLockInstant);
                        }
                        return "";
                    });
                ...
                case 1: {
                    ...
                    if (position == changePasscodeRow) {
                        ...
                        if (SharedConfig.autoLockIn == Integer.MAX_VALUE) {
                            val = LocaleController.formatString("OwlgramAutoLockInstant", R.string.OwlgramAutoLockInstant);
