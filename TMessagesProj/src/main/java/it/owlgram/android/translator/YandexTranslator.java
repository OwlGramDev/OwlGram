...
public class YandexTranslator extends BaseTranslator {
    ...
    protected Result translate(String query, String tl) throws IOException, JSONException {
        return getResult(new StandardHTTPRequest("https://translate.yandex.net/api/v1/tr.json/translate?srv=android&&uuid=" + uuid)
                .header("Content-Type", "application/x-www-form-urlencoded")
                .header("User-Agent", "ru.yandex.translate/21.9.2.21342195 (Xiaomi Redmi K20 Pro; Android 11)")
