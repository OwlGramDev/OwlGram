...
public class DrawerOrderSettings extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("OwlgramMenuItems", R.string.OwlgramMenuItems));
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 3:
                    ...
                    if (position == headerSuggestedOptionsRow) {
                        headerCell.setText(LocaleController.getString("OwlgramSuggestedMenuItems", R.string.OwlgramSuggestedMenuItems));
                    } else if (position == headerMenuRow) {
                        headerCell.setText(LocaleController.getString("OwlgramMenuItems", R.string.OwlgramMenuItems));
                    }
                    break;
                case 4:
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 2:
                    view = new HintHeaderCell(mContext, R.raw.filters, LocaleController.formatString("OwlgramSideBarOrderHint", R.string.OwlgramSideBarOrderHint));
