...
public abstract class GrammarUtils {
    ...
    public static Prism4j.Grammar require(Prism4j prism4j, @NonNull String lang) {
        return prism4j
                .grammar(lang)
                .orElseThrow(NoSuchGrammarException.supply(Objects.requireNonNull(lang)));
    }
    ...
    public interface TokenFilter {
        ...
        /**
         * @param token {@link  it.owlgram.android.entities.syntax_highlight.prism4j.Prism4j.Token} to validate
     ...
     *
     * @param grammar {@link it.owlgram.android.entities.syntax_highlight.prism4j.Prism4j.Grammar}
     * @param path    argument to find a {@link it.owlgram.android.entities.syntax_highlight.prism4j.Prism4j.Token}
     * @return a found {@link it.owlgram.android.entities.syntax_highlight.prism4j.Prism4j.Token} or null
     */
    @Nullable
